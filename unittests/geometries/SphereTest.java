...
class SphereTest {
    ...
    public void testFindIntersections() {
        ...
        assertNull(
                sphere.findIntersections(new Ray(pOutside, v110)),
        ...
        assertNotNull(
                result2,
                "Ray crosses sphere but result is null"
        );
        assertEquals(
                2,
                result2.size(),
        ...
        assertEquals(
                List.of(gp4),
                result14,
                "Ray starts at sphere and goes through the center"
        );
        ...
        assertEquals(
                List.of(gp3),
                result15,
                "Ray starts inside and goes through the center"
        );
