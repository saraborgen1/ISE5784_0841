...
class LightTests {
    ...
    public void sphereDirectional() {
        ...
        camera1.setImageWriter(
                        new ImageWriter("lightSphereDirectional", 500, 500)
                )
                .build()
                .renderImage()
                .writeToImage();
    ...
    public void spherePoint() {
        ...
        camera1.setImageWriter(
                        new ImageWriter("lightSpherePoint", 500, 500))
                .build()
                .renderImage()
                .writeToImage();
    }
    ...
    public void sphereSpot() {
        ...
        camera1.setImageWriter(
                        new ImageWriter("lightSphereSpot", 500, 500))
                .build()
                .renderImage()
                .writeToImage();
    }
    ...
    public void sphereMultipleLights() {
        ...
        scene1.lights.addAll(
                List.of
                        (new DirectionalLight(
                                ...
                                (new PointLight(
                                        new Color(500, 300, 0),
                                        new Point(-50, 50, 50)).setKL(0.0001).setKQ(0.0001)
                                ),
                                (new SpotLight(
                                        new Color(600, 400, 0),
                                        new Point(50, -50, 50),
        ...
        camera1.setImageWriter(
                        new ImageWriter("sphereMultipleLights", 500, 500)
                )
                .build()
                .renderImage()
                .writeToImage();
